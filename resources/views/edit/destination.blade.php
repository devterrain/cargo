...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">إعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ وجهات الوصول</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@section('content')
						...
						<div class="card">
							<div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافة وجهات وصول جديدة</a>
                                </div>
                            </div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-15p border-bottom-0">الوجهة</th>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">وجهة وصول جديدة</h6><button aria-label="Close" class="close" data-dismiss="modal"
						...
						<div class="modal-body">
							<form action="{{ route('destination.store') }}" method="post">
								...
								<div class="form-group">
									<label for="text">اسم الوجهة</label>
			...
			<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
				   ...
				   <div class="modal-dialog" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">تعديل بيانات وجهة الوصول</h6><button aria-label="Close" class="close" data-dismiss="modal"
								type="button"><span aria-hidden="true">&times;</span></button>
						</div>
						<div class="modal-body">
							<form action="destination/update" method="post">
								{{method_field('patch')}}
								@csrf
								<div class="form-group">
									<input type="hidden" name="id" id="id" value="">
									<label for="text">وجهة الوصول</label>
