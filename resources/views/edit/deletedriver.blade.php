    ...
    @endif
                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافة سائق جديد</a>
                                </div>
                            </div>
                            <div class="card-body">
											...
											<tr>
												...
												<td>
                                                    <a class="modal-effect btn btn-lg btn-info" data-effect="effect-scale"
													   ...
													   data-driver_address="{{ $driver->driver_address }} "data-driver_birthday="{{ $driver->driver_birthday }}"
													   data-licence_type="{{ $driver->licence_type }}" data-licence_num="{{ $driver->licence_num }}"
													   data-hiring_date="{{ $driver->hiring_date }}" data-driver_code="{{ $driver->driver_code }}"
													   data-contractor_id="{{ $driver->contractor_id }}" data-identity_num="{{ $driver->identity_num }}"
													   data-driver_notes="{{ $driver->driver_notes }}" data-toggle="modal" href="#exampleModal2"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content modal-content-demo">
								<div class="modal-header">
									<h6 class="modal-title">اضافة سائق جديد</h6><button aria-label="Close" class="close" data-dismiss="modal"
								...
								<div class="modal-body">
									<form action="{{route('driver.store')}}" method="post" autocomplete="off">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control form-control-lg" id="driver_name" name="driver_name" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control form-control-lg" id="driver_address" name="driver_address">
										</div>
										<div class="form-group">
											<label for="text">تاريخ الميلاد</label>
											<input type="date" class="form-control form-control-lg" id="driver_birthday" name="driver_birthday">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input type="number" class="form-control form-control-lg" id="licence_num" name="licence_num">
										</div>
										<div class="form-group">
											<label for="text">رقم البطاقة</label>
											<input type="number" class="form-control form-control-lg" id="identity_num" name="identity_num">
										</div>
										<div class="form-group">
											<label for="text">تاريخ التعيين</label>
											<input type="date" class="form-control form-control-lg" id="hiring_date" name="hiring_date">
										</div>
										<div class="form-group">
											<label for="text">كود السائق</label>
											<input type="num" class="form-control form-control-lg" id="driver_code" name="driver_code">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<textarea class="form-control form-control-lg" id="driver_notes" name="driver_notes"></textarea>
										</div>
				...
				<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
				   ...
				   <div class="modal-dialog" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">تعديل بيانات السائق</h6><button aria-label="Close" class="close" data-dismiss="modal"
								type="button"><span aria-hidden="true">&times;</span></button>
						</div>
						<div class="modal-body">
			   ...
			   <div class="modal" id="modaldemo9">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">حذف سائق</h6><button aria-label="Close" class="close" data-dismiss="modal"
								type="button"><span aria-hidden="true">&times;</span></button>
						</div>
						<form action="driver/destroy" method="post">
							...
							<div class="modal-body">
								...
								<input type="hidden" name="id" id="id" value="">
								<input class="form-control form-control-lg" name="driver_name" id="driver_name" type="text" readonly>
							</div>
							<div class="modal-footer">
