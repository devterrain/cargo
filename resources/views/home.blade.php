...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">كايرو ثري ايه الدولية للاستثمار</h2>
						  <p class="mg-b-0">منظومة متابعة حركة البضائع.</p>
						</div>
					</div>
					<div class="main-dashboard-header-right">
						<div>
							<label class="tx-13">عمليات النقل من المصانع</label>
							<h5>{{$totalCounts}} عملية</h5>
						</div>
						<div>
							<label class="tx-13">عمليات شحن السفن</label>
							<h5>{{$totalshippings}} عملية</h5>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
				...
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">عدد السيارات اليوم</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$count}} سيارة</h4>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">الكمية المحملة اليوم (بالطن)</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{number_format($totalweight / 1000)}} طن</h4>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{$store->store_name}}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{number_format($store->store_quat)}} طن</h4>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7"></span>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">سيارات محملة في الطريق إلى الميزان</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$ontheroad}} سيارة </h4>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">عدد عمليات الشحن</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$storageop}} عملية </h4>

										</div>
										<span class="float-right my-auto mr-auto">
												<i class="fas fa-arrow-circle-down text-white"></i>
												<span class="text-white op-7"> {{number_format($storageopwights)}} طن</span>
											</span>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">عدد عمليات النقل بين المخازن</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$inbetweens}} عملية </h4>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                        <div class="card overflow-hidden sales-card bg-primary-gradient">
                            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                                <div class="">
                                    <h6 class="mb-3 tx-12 text-white">عمليات الشحن قيد التنفيذ</h6>
                                </div>
                                <div class="pb-0 mt-0">
                                    <div class="d-flex">
                                        <div class="">
                                            <h4 class="tx-20 font-weight-bold mb-1 text-white">{{$underways}} عملية </h4>
						...
						<div class="card card-table-two">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mb-0">سيارات خرجت من المصنع في الطريق إلى الميزان</h4>
								...
								<div class="table-responsive country-table">
									<table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
											...
											<tr>
												...
												<th class="wd-5p border-bottom-0"> البوليصة</th>
												<th class="wd-5p border-bottom-0">تاريخ </th>
												<th class="wd-10p border-bottom-0">السيارة</th>
												<th class="wd-10p border-bottom-0">اسم السائق</th>
												<th class="wd-10p border-bottom-0">الوزن الصافي</th>
												<th class="wd-10p border-bottom-0">مغادرة المصنع</th>
											</tr>
											</thead>
											<tbody>
											<?php $i = 0; ?>
											@foreach($policydetails as $policydetail)
												...
												<tr>
													...
													<td class="tx-right tx-medium tx-inverse">U {{$policydetail->policy->id}}</td>
													<td class="tx-right tx-medium tx-inverse">{{$policydetail->policy->shipping_date}}</td>
													<td class="tx-right tx-medium tx-inverse">{{$policydetail->policy->vehicle->plate_num}}</td>
													<td class="tx-right tx-medium tx-inverse">{{$policydetail->policy->driver->driver_name}}</td>
													<td class="tx-right tx-medium tx-inverse">{{number_format($policydetail->policy->net_weight)}}</td>
													<td class="tx-right tx-medium tx-inverse">{{$policydetail->policy->created_at}}</td>
												</tr>
											@endforeach
											</tbody>
										</table>
